...
// --- Configuration ---
export const api_base = "http://192.168.1.118:5000"; // Replace with your actual API base URL
...
const API_BASE_URL = `${api_base}/api`; // For Physical Device (Replace with your IP)
