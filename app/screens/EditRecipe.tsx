...
async function updateRecipe(id: string, recipeData: any) {
...
export default function EditRecipe() {
  ...
  const fetchRecipe = async () => {
    try {
      ...
      setMainImageUrl(recipe.mainImage);
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      handleNotification({
        title: `Recipe ${recipeData.title} updated`,
        body: "Your recipe has been updated successfully!",
        trigger: null,
      });
      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{ padding: 20, paddingTop: 60 }}>
          ...
          >
            ...
            <Button title="Update Recipe" onPress={handleUpdate} color="#f90" />
          </View>
        </ScrollView>
      </View>
    </SafeAreaView>
